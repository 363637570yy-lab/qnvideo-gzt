  ...
  },
  {
    ...
    options: [
      ...
      { label: '写实二次元', value: 'realistic anime',
        ...
        color: 'linear-gradient(135deg,#7c83fd,#2dd4bf)', thumb: '/style-thumbs/anime.jpg' },
  ...
  },
  {
    ...
    options: [
      { label: '2D 古风', value: '2d gufeng',
        ...
        color: 'linear-gradient(135deg,#e8dcc8,#9b7653)', thumb: '/style-thumbs/historical.jpg' },
      { label: '仙侠 3D', value: 'xianxia 3d',
        ...
        color: 'linear-gradient(135deg,#1a3a52,#7ec8e3)', thumb: '/style-thumbs/fantasy.jpg' },
      { label: '古风 3D', value: 'gufeng 3d',
        ...
        color: 'linear-gradient(135deg,#5c4033,#c9a227)', thumb: '/style-thumbs/3d-render.jpg' },
      { label: '新中式国潮', value: 'neo chinese guochao',
        ...
        color: 'linear-gradient(135deg,#c41e3a,#1a1a2e)', thumb: '/style-thumbs/chinese.jpg' },
      { label: '新古风', value: 'neo gufeng',
        ...
        color: 'linear-gradient(135deg,#f5e6d3,#b8860b)', thumb: '/style-thumbs/ink-wash.jpg' },
      { label: '都市现言漫画', value: 'urban romance comic',
        ...
        color: 'linear-gradient(135deg,#ffeef8,#a78bfa)', thumb: '/style-thumbs/comic.jpg' },
      { label: '韩漫纯爱', value: 'korean romance webtoon',
        ...
        color: 'linear-gradient(135deg,#ffd6e8,#b4a7d6)', thumb: '/style-thumbs/anime.jpg' },
    ]
  },
  {
    label: '绘画艺术',

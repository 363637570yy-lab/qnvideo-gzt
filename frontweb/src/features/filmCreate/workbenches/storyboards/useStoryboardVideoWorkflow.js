...
import { useStoryboardVideoModelRoute } from './useStoryboardVideoModelRoute'
import { useStoryboardVideoPrompts } from './useStoryboardVideoPrompts'
import { useStoryboardVideoReferences } from './useStoryboardVideoReferences'
...
export function useStoryboardVideoWorkflow(deps = {}) {
  ...
  } = useStoryboardVideoModelRoute({ aiAPI })
